...
public class OpenCVAprilTag extends LinearOpMode
{
    ...
    public static DcMotor front_left_motor, front_right_motor, back_left_motor, back_right_motor;
    ...
    @Override public void runOpMode()
    {
        ...
        front_left_motor = hardwareMap.get(DcMotor.class, "Front Left Motor");
        front_right_motor = hardwareMap.get(DcMotor.class, "Front Right Motor");
        back_left_motor = hardwareMap.get(DcMotor.class, "Back Left Motor");
        back_right_motor = hardwareMap.get(DcMotor.class, "Back Right Motor");

        front_left_motor.setDirection(DcMotor.Direction.REVERSE);
        back_left_motor.setDirection(DcMotor.Direction.REVERSE);

        // If you are having problems with motion blur, lower the exposure.
        // Somewhere in the range of 4-10 seems to work well for most cameras.
        ...
        while (opModeIsActive())
        {
            ...
            if (targetFound) {
                ...
                /*This code might need to be removed*/
            } else {
                drive = 0;
                turn = 0;
            }
