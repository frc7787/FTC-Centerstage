...
public class BlueLeftShort extends LinearOpMode  {
    PropDetector detector = new PropDetector(PropColor.BLUE);
    Pose2d START_POS = new Pose2d(-36, 71.7, Math.toRadians(270));
    ...
    TrajectorySequence to_pixel_stack = drive.trajectorySequenceBuilder(new Pose2d(-36, 64.5, Math.toRadians(0)))
            ...
            .lineTo(new Vector2d(-59.5, 36))
            .build();

    TrajectorySequence to_backdrop_from_pixel_stack = drive.trajectorySequenceBuilder(new Pose2d(-59.5, 36))
            .lineTo(new Vector2d(39, 36.6))
            .build();

    TrajectorySequence to_pixel_stack_from_backdrop = drive.trajectorySequenceBuilder(new Pose2d(39, 36.5))
            .lineTo(new Vector2d(-59.5, 36))
            .build();
